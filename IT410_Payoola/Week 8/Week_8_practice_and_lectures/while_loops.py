...
while program_running:
    ...
    phone_first_part = input("Enter first three digits of your phone number: ")
...
# end processing first part of phone number
    ...
    phone_numbers.append({'area_code': area_code, 'first part': phone_first_part, 'second_part': phone_second_part})
